...
class YoutubeDownloader:
    ...
    def single_video_download(self, url, save_path):
        try:
            yt = YouTube(url)
    ...
    def playlist_download(self, url, save_path):
        try:
            p = Playlist(url)
    ...
    def video_as_audio_download(self, url, save_path):
        try:
            yt = YouTube(url)
    ...
    def playlist_as_mp3_download(self, url, save_path):
        try:
            p = Playlist(url)
            for video_url in p.video_urls:
